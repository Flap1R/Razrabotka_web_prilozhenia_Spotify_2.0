                ...
                <form className="text-center mx-auto w-1/2">
                    <div className='w-full text-left py-4'>
                        ...
                        <input 
                            ...
                            className="block w-full rounded-[4px] border-0 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300
                    ...
                    <div className='w-full text-left py-4'>
                        ...
                        <input 
                            ...
                            value="Log in"
                            placeholder="Password"
                            className="block w-full outline-none bg-green-400 text-black p-3 hover:scale-105 translate-all duration-200 font-medium
