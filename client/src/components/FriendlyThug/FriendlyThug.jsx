    ...
    <Layout>
      ...
      <div className="min-h-screen flex-grow ml-2 z-1 bg-opacity-60 bg-blur">
        <div className="relative h-96">
          <img src="/assets/fdthug_logo.jpeg" alt="" className="rounded-[6px] left-30 w-full h-full object-cover" />
          <div className="absolute top-0 left-0 right-0 bottom-0 p-8 md:p-12 flex flex-col z-3">
            <div className="mt-auto text-white flex items-center justify-between">
              <div className="left">
                ...
                <div className="flex items-center">
                  <h2 className="text-5xl">FRIENDLY THUG 52 NGG</h2>
                </div>
                ...
                <p className="flex mt-2 text-base">
                  ...
                  486 965 <span className="top-2 ml-2">Monthly Listeners</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <ul className="flex items-center">
            ...
            <p className="text-xs text-gray-300 mx-4">
                ...
                162K <span>Followers</span>
            </p>
        </div>

        <p className="flex mt-5 text-5x mx-4">
        2K-Cty 52 NGG ‼️ В.💢 All My Members Are CEO💯 Most Valuable Pirates 🏴🐐💫 812 (c) 52
        </p>
      </div>
